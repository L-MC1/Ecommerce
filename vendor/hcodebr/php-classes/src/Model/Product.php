...
class Product extends Model {
	...
	public function save(){
		...
		$results = $sql->select("CALL db_ecommerce.sp_products_save (:idproduct, :desproduct, :vlprice, :vlwidth, :vlheight, :vllength, :vlweight, :desurl)", array(
