		...
		<div class="row">
			<div class="col-md-12">
				<div class="product-content-right">
					<form action="/ecommerce/views/checkout" class="checkout" method="post" name="checkout">
								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="method-paypal" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">						
											...
											<p id="method-paypal" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">						
												<input type="radio" id="method-paypal" name="payment-method" value="2" style="float:left; margin: 30px;">
